        ...
        <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden lg:max-w-6xl">
            <div class="px-6 py-4">
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">{{ Auth::user()->full_name }}</td>
                        </tr>
                        <tr>
                ...
                <div class="flex justify-between items-center mt-6">
                    <p>Terima kasih telah membeli tiket di {{ config('app.name') }}. Nikmati perjalanan Anda!</p>
                    <button class="no-print btn bg-success text-white" onclick="window.print()">Print</button>
                </div>
            </div>
        </div>
    </div>
