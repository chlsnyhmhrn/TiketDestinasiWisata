...
<body class="bg-success flex justify-center items-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-md w-96">
        ...
        <div class="flex gap-2 items-center mb-4">
            <div class="w-full">
                <button type="reset" id="pembeli" name="rolepembeli"
                    class="w-full px-2 py-2 border rounded-md focus:outline-none focus:border-green-500 bg-success text-white">Pembeli</button>
            </div>
            <div class="w-full">
                <a href="/register_penjual"><button type="button" id="penjual" name="rolepenjual"
                        class="w-full px-2 py-2 border rounded-md focus:outline-none focus:border-green-500 ">Penjual</button></a>
            </div>
        </div>
        <form id="registrationForm" action="{{ route('actionRegister') }}" method="post">
            ...
            <div class="mb-4" hidden>
                ...
                <input type="number" value="3" id="user_type" name="user_type"
            ...
            <div class="mb-4">
                <label for="full_name" class="font-bold block mb-2">Nama Lengkap</label>
                <input type="full_name" id="full_name" name="full_name"
                    class="bg-gray-300 w-full px-4 py-2 border border-gray-300 rounded-2xl focus:outline-none focus:border-green-500"
                    required>
            </div>
            <div class="mb-4">
